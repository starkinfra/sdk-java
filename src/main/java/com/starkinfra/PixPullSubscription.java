...
public final class PixPullSubscription extends Resource {
     ...
     * type [string]: Subscription journey type. ex: "push"
     ...
     * pullRetryLimit [Long]: Defines if the receiver is able to create Pix Pull Request for retries.
     ...
     * @param type [string]: Subscription journey type. ex: "push"
     ...
     * @param referenceCode [string, default null]: Represents the commercial relation. It can be a contract number, order identification or client code.
     * @param pullRetryLimit [Long, default null]: Defines if the receiver is able to create Pix Pull Request for retries.
     * @param senderCityCode [string, default null]: IBGE Code of the payer's city.
     ...
     * referenceCode [string, default null]: Represents the commercial relation. It can be a contract number, order identification or client code.
     * pullRetryLimit [Long, default null]: Defines if the receiver is able to create Pix Pull Request for retries.
     * senderCityCode [string, default null]: IBGE Code of the payer's city.
     ...
     * Parameters:
     * @param id [string]: PixPullSubscription unique id. ex: "5656565656565656"
     * @param reason [string]: Reason why the Pix Pull Subscription is being canceled. Options: "accountClosed", "receiverOrganizationClosed", "receiverInternalError", "fraud", "receiverUserRequested", "senderDeceased", "senderUserRequested"
     * <p>
     * Return:
     * @return canceled PixPullSubscription object
     * @throws Exception error in the request
    ...
    public final static class Log extends Resource {
         ...
         */
        public Log(String created, String type, List<String> errors, String description, String reason,
