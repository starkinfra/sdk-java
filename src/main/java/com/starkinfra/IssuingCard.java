...
public final class IssuingCard extends Resource {
     ...
     * streetLine1       [string]: card holder main address. ex: "Av. Paulista, 200"
     * streetLine2       [string, default ""]: card holder address complement. ex: "Apto. 123"
     * district          [string]: card holder address district / neighbourhood. ex: "Bela Vista"
     * city              [string, default ""]: card holder address city. ex: "Rio de Janeiro"
     * stateCode         [string, default ""]: card holder address state. ex: "GO"
     * zipCode           [string]: card holder address zip code. ex: "01311-200"
     ...
     * @param streetLine1       [string, default ""]: card holder main address. ex: "Av. Paulista, 200"
     * @param streetLine2       [string, default ""]: card holder address complement. ex: "Apto. 123"
     * @param district          [string]: card holder address district / neighbourhood. ex: "Bela Vista"
     * @param city              [string, default ""]: card holder address city. ex: "Rio de Janeiro"
     * @param stateCode         [string, default ""]: card holder address state. ex: "GO"
     * @param zipCode           [string]: card holder address zip code. ex: "01311-200"
     ...
     */
    public IssuingCard(String holderName, String holderTaxId, String holderExternalId, String displayName, List<IssuingRule> rules, String binId, String[] tags, String streetLine1, String streetLine2, String district, String city, String stateCode, String zipCode, String id, String holderId, String type, String status, String number, String securityCode, String expiration, String updated, String created){
        super(id);
     ...
     * tags [list of strings]: list of strings for tagging. ex: ["travel", "food"]
     * streetLine1 [string, default ""]: card holder main address. ex: "Av. Paulista, 200"
     * streetLine2 [string, default ""]: card holder address complement. ex: "Apto. 123"
     * district [string]: card holder address district / neighbourhood. ex: "Bela Vista"
     * city [string, default ""]: card holder address city. ex: "Rio de Janeiro"
     * stateCode [string, default ""]: card holder address state. ex: "GO"
     ...
     * Retrieve paged IssuingCards
     * <p>
     * Receive a list of up to 100 IssuingCard objects previously registered in the Stark Bank API and the cursor to the next page.* <p>
     * Parameters:
     * @param user [Project object, default null]: Project object. Not necessary if StarkInfra.Settings.user was set before function call
     * <p>
     * Return:
