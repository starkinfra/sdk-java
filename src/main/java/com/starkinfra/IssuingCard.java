...
public final class IssuingCard extends Resource {
     ...
     * <p>
     * Parameters:
     * @parma holderName [string]: card holder name. ex: "Tony Stark"
     * @parma holderTaxId [string]: card holder tax ID. ex: "012.345.678-90"
     * @parma holderExternalId [string]: card holder unique id, generated by the user to avoid duplicated holders. ex: "my-entity/123"
     * @parma displayName [string, default ""]: card displayed name. ex: "ANTHONY STARK"
     * @parma rules [list of IssuingRule or HashMap, default []]: [EXPANDABLE] list of card spending rules.
     * @parma productId [string, default ""]: card product ID to which the card is bound. ex: "53810200"
     * @parma tags [list of strings, default []]: list of strings for tagging. ex: ["travel", "food"]
     * @parma streetLine1 [string, default sub-issuer street line 1]: card holder main address. ex: "Av. Paulista, 200"
     * @parma streetLine2 [string, default sub-issuer street line 2]: card holder address complement. ex: "Apto. 123"
     * @parma district [string, default sub-issuer district]: card holder address district / neighbourhood. ex: "Bela Vista"
     * @parma city [string, default sub-issuer city]: card holder address city. ex: "Rio de Janeiro"
     * @parma stateCode [string, default sub-issuer state code]: card holder address state. ex: "GO"
     * @parma zipCode [string, default sub-issuer zip code]: card holder address zip code. ex: "01311-200"
     * @parma id [string]: unique id returned when IssuingCard is created. ex: "5656565656565656"
     * @parma holderId [string]: card holder unique id. ex: "5656565656565656"
     * @parma type [string]: card type. ex: "virtual"
     * @parma status [string]: current IssuingCard status. ex: "canceled" or "active"
     * @parma number [string]: [EXPANDABLE] masked card number. Expand to unmask the value. ex: "123".
     * @parma securityCode [string]: [EXPANDABLE] masked card verification value (cvv). Expand to unmask the value. ex: "123".
     * @parma expiration [string]: [EXPANDABLE] masked card expiration datetime. Expand to unmask the value. ex: "2020-03-10 10:30:00.000000+00:00"
     * @parma updated [string]: latest update datetime for the IssuingCard. ex: "2020-03-10 10:30:00.000000+00:00"
     * @parma created [string]: creation datetime for the IssuingCard. ex: "2020-03-10 10:30:00.000000+00:00"
     */
    public IssuingCard(String holderName, String holderTaxId, String holderExternalId, String displayName,
                       List<IssuingRule> rules, String productId, String[] tags, String streetLine1, String streetLine2,
     ...
     * <p>
     * Return:
     * @return generator of IssuingCard objects with updated attributes
     * @throws Exception error in the request
     */
