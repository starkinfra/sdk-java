...
public final class CreditNote extends Resource {
     ...
     * nominalAmount    [number]: amount in cents transferred to the credit receiver, before deductions. ex: 11234 (= R$ 112.34)
     ...
     * Parameters (optional):
     * rebateAmount     [number, default null]: credit analysis fee deducted from lent amount. ex: 11234 (= R$ 112.34)
     ...
     * @param nominalAmount    [number]: amount in cents paid to the credit receiver, before deductions. ex: 11234 (= R$ 112.34)
     ...
     * @param rebateAmount     [number, default null]: credit analysis fee deducted from lent amount. ex: 11234 (= R$ 112.34)
     ...
     */
    public CreditNote(  
        String templateId, String name, String taxId, Number nominalAmount, String scheduled, List<CreditNote.Invoice> invoices,
        Resource payment, List<CreditNote.Signer> signers, String externalId, String streetLine1,
        ...
        String[] transactionIds, String workspaceId, Number taxAmount, Number interest, String created, String updated
    ) throws Exception{
        super(id);
    ...
    @SuppressWarnings("unchecked")
    private List<CreditNote.Signer> parseSigners(List<Object> signers) throws Exception {
        if (signers == null)
            return null;

        List<CreditNote.Signer> parsed = new ArrayList<>();
        if (signers.size() == 0 || signers.get(0) instanceof CreditNote.Signer) {
            for (Object signer : signers) {
                parsed.add((CreditNote.Signer) signer);
            }
        ...
        for (Object signer : signers) {
            CreditNote.Signer signerObject = new CreditNote.Signer((Map<String, Object>) signer);
    ...
    @SuppressWarnings("unchecked")
    private List<CreditNote.Invoice> parseInvoices(List<Object> invoices) throws Exception {
        if (invoices == null)
            return null;
    ...
    public static final class Signer extends SubResource{
        /**
         ...
         */
        static ClassData data = new ClassData(Signer.class, "Signer");
         ...
         * <p>
         * Parameters (required):
         * @param name          [string]: signer name. ex: "Tony Stark"
    ...
    public static final class Transfer extends Resource{
        ...
        public Transfer(String name, String taxId, String bankCode, String branchCode, String accountNumber,
                        String accountType, String[] tags, Number amount, String externalId, String scheduled,
                        String description, String id, Number fee, String status, String[] transactionIds,
    ...
    public static final class Invoice extends Resource{
         ...
         * fee               [number]: fee charged by this Invoice. ex: 200 (= R$ 2.00)
         ...
         * <p>
         * Parameters (required):
         * @param amount            [number]: Invoice value in cents. Minimum = 1 (any value will be accepted). ex: 1234 (= R$ 12.34)
         * Parameters (optional):
         ...
         * @param fee               [number]: fee charged by this Invoice. ex: 200 (= R$ 2.00)
         ...
         */
        public Invoice(
            Number amount, String due, Number expiration, String[] tags, List<CreditNote.Invoice.Description> descriptions,
            String name, String taxId, String pdf, String link, Number fine, Number interest, Number nominalAmount,
            Number fineAmount, Number interestAmount, Number discountAmount, List<CreditNote.Invoice.Discount> discounts,
            String id, String brcode, String status, Number fee, String[] transactionIds, String created, String updated
        ){
            super(id);
            this.amount = amount;
            this.due = due;
