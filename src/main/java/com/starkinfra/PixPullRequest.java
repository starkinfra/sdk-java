...
public final class PixPullRequest extends Resource {
     ...
     * senderFinalTaxId [string]: sender's final tax ID (CPF or CNPJ).
     ...
     * @param senderFinalTaxId [string]: sender's final tax ID (CPF or CNPJ).
    ...
    public PixPullRequest(Long amount, String due, String endToEndId, String receiverAccountNumber,
                          ...
                          String receiverTaxId, String senderBankCode, String senderFinalName,
                          String senderFinalTaxId, String senderTaxId
    ) {
        super(id);
        this.amount = amount;
        this.due = due;
     ...
     * "accountClosed", "accountBlocked", "pixRequestFailed", "other", "senderUserRequested", "receiverUserRequested".
     * <p>
     * Parameters:
     * @param id [string]: PixPullRequest unique id. ex: "5656565656565656"
     * @param reason [string]: reason why the Pix Pull Request is being canceled. Options: "accountClosed", "accountBlocked", "pixRequestFailed", "other", "senderUserRequested", "receiverUserRequested"
     * <p>
     * Return:
     * @return canceled PixPullRequest object
     * @throws Exception error in the request
    ...
    public final static class Log extends Resource {
         ...
         * @param errors [list of ErrorElement]: list of errors linked to this PixPullRequest event
         ...
         */
        public Log(String created, String type, List<ErrorElement> errors, String description, String reason, PixPullRequest request, String id) {
            super(id);
            this.created = created;
            this.type = type;
            this.errors = errors;
