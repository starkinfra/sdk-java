...
public final class PixFraud extends Resource {
    ...
    public final static class Log extends Resource {
        static ClassData data = new ClassData(Log.class, "PixFraudLog");
         ...
         * <p>
         * Return:
         * @return PixFraud Log object with updated attributes
         * @throws Exception error in the request
         */
         ...
         * fraudIds [list of strings, default null]: list of PixFraud IDs to filter retrieved objects. ex: ["5656565656565656", "4545454545454545"]
         * ids [list of strings, default null]: Log ids to filter PixFraud Logs. ex: ["5656565656565656"]
         * <p>
         * Return:
         * @return generator of PixFraud Log objects with updated attributes
         * @throws Exception error in the request
         */
         ...
         * <p>
         * Return:
         * @return PixFraud.Log.Page object:
         * PixFraud.Log.Page.logs: list of PixFraud.Log objects with updated attributes
         * PixFraud.Log.Page.cursor: cursor to retrieve the next page of PixFraud.Log objects
         * @throws Exception error in the request
         */
